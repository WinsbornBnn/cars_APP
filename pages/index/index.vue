      ...
      <view class="page-section page-section-gap">
        ...
        <view class="nav-bottom">
          <view class="padding-lr bg-white">
            ...
            <view class="padding-top solid-bottom" @click="getlocal()"
              >当前位置：{{ address }}</view
            >
            <view class="button-group">
              ...
              <button
                @click="AddPage"
                style="background-color: #275c9f;color:#fff;font-size: 16px;width: 220px;"
              >
                <text class="cuIcon-camera text-df padding-right"></text
                >怕照上报
              </button>
            </view>
          </view>
