<template>
	<view>
		...
		<uni-notice-bar showIcon="true" showClose="true" background-color="#fff" color="#ff0000" scrollable="true"
			:speed="50" single="true" text="当提示请拍摄或选择有位置的图片时,打开手机定位功能,用手机相机拍摄,上传带有地址的图片"></uni-notice-bar>
		<view class="padding">
			<view class="padding-xl radius shadow shadow-lg bg-white" id="shadow">车牌号：
				<input type="text" v-model="carId" />
			</view>
			<view class="padding-xl radius shadow shadow-lg bg-white margin-top">
				<text>车辆到货地点照片（需包含车辆）</text>
				<image @tap="addLocalImages" :src="localImages" style="width: 100%; height: 300upx"></image>
			</view>

			<view class="padding-xl radius shadow shadow-lg bg-white margin-top">
				<text>请添加车辆正面照片</text>
				<image @tap="addCarImages" :src="carImages" style="width: 100%; height: 300upx"></image>
			</view>
		</view>
