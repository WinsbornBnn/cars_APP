<template>
	<view>
		...
		<view class="bg-white goods_title" :style="[{height:titleheight+'px'}]">
			<!-- 轮播图 -->
			<view class="swiper">
				<view class="swiper-box">
					<swiper :circular="true" :autoplay="true" :indicator-dots="true" interval="5000" duration="500">
						<swiper-item v-for="(item, index) in swiperList" :key="index">
							<image style="border-radius: 15px" :src="item.url" mode="aspectFill"
		...
		<!-- 商品列表 -->
		<view class="goods-list" style="margin-top: 20px;">
