<template>
	<view>
		...
		<!-- 轮播图 -->
		<view class="swiper" style="margin-top: 80px;">
		...
		<!-- 商品列表 -->
		<view class="goods-list margin-bottom">
			<view class="title">
				<image src="/static/hua.png"></image>
				猜你喜欢
				<image src="/static/hua.png"></image>
			</view>
...
export default {
	data() {
		return {
			...
			// 轮播图片
			swiperList: [
				{ id: 1, src: 'url1', img: '../../static/gys/drawable-xxhdpi/faxian_banner.png' },
				{ id: 2, src: 'url2', img: '../../static/gys/drawable-xxhdpi/dingdan_bannner.png' },
			],
			Promotion: [],
			//猜你喜欢列表
			productList: [
